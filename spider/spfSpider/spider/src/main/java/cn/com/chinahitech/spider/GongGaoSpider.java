...
public class GongGaoSpider {
    static String START_URL = "http://www.neeq.com.cn/products/neeq_listed_companies/related_announcement.html?companyCode=430001";
...
//        System.out.println(url);
        ...
        httpGet.setHeader("Cookie", "Hm_lvt_b58fe8237d8d72ce286e1dbd2fc8308c=1594879482,1594989650,1595038315,1595473429; neeqtoken=JEF56VqU0RyvwOfC5rI0eWgn8G6Xdo4UB0HqEyoH5lH84X0RH2qMpKRszBfz2a9AnwyerrEzAiM3D3xk3FffGQ==%2Cfalse%2Cspf159; JSESSIONID=11082E8F34D8F8786BF75065BAE739DF; BIGipServerNEEQV1.3C_WEB_8000=268501940.16415.0000; Hm_lpvt_b58fe8237d8d72ce286e1dbd2fc8308c=1595474588");
        // 3. 执行请求
    ...
    private void parseHtmlRange(String content) {
        ...
        String test=document.select("div.context").html();
        System.out.println(test);
    }

    public static void main(String[] args){
        GongGaoSpider gongGaoSpider=new GongGaoSpider();
        gongGaoSpider.requestData();
    }
}
